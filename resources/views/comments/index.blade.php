            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right"><a href="{{ route('comments.show',$comment->id) }}" class="btn btn-default btn-sm">View</a> <a href="{{ route('comments.edit', $comment->id) }}" class="btn btn-default btn-sm">Edit</a></td>
                    </tr>
